 ...
 */
void draw_text(uint8_t x, uint8_t y, char* text, uint8_t width, uint8_t height, uint8_t orientation, prog_uchar* font, prog_uchar* codepage, uint8_t overlay);

/*
 * Draws a bitmap on the screen at the specified position, of specified width / height,
 * in the specified overlay mode.
 */
void draw_bitmap(uint8_t x, uint8_t y, uint8_t width, uint8_t height, uint8_t orientation, prog_uchar* bitmap, uint8_t overlay);

/*
 * Draws a line between two points x0,y0 to x1,y1.  Overlay (o) determines the
 * overlay mode to use.
 */
void draw_line(uint8_t x0, uint8_t y0, uint8_t x1, uint8_t y1, uint8_t overlay);
 ...
 */
void draw_rectangle(uint8_t x0, uint8_t y0, uint8_t x1, uint8_t y1, uint8_t f, uint8_t overlay);
 ...
 */
 void draw_circle(uint8_t x, uint8_t y, uint8_t r, uint8_t f, uint8_t overlay);
