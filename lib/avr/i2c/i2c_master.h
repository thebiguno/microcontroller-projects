...
****************************************************************************/
void i2c_master_init(int i2c_clock_frequency);
uint8_t i2c_get_state_info();
void i2c_start_transceiver_with_data(uint8_t *msg, uint8_t msgSize);
...
#define I2C_READ		1		//Value to indicate reading
#define I2C_WRITE		0		//Value to indicate writing
