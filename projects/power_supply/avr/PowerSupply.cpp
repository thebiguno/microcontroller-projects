...
#endif
#if CHANNEL_COUNT > 2
	Channel(2, DAC_ADDRESS_1, DAC_CHANNEL_0, DAC_CHANNEL_1, ADC_CHANNEL_6, ADC_CHANNEL_7, 12000, 1000),
#endif
#if CHANNEL_COUNT > 3
	Channel(3, DAC_ADDRESS_1, DAC_CHANNEL_2, DAC_CHANNEL_3, ADC_CHANNEL_8, ADC_CHANNEL_9, -12000, 500),
#endif
#if CHANNEL_COUNT > 4
