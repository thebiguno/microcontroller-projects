...
#define MESSAGE_GET_CHANNEL_INFO			2
...
//This is a 'measurement' type message
#define MESSAGE_GET_ACTUAL					3
...
//This is a 'measurement' type message
#define MESSAGE_GET_ACTUAL_RAW				4
...
//This is a 'measurement' type message
#define MESSAGE_GET_SETPOINT_RAW			6
...
//This is a 'measurement' type message
#define MESSAGE_SET_SETPOINT				7

//Computer -> PSU: Change raw setpoints for given channel: [channel:1][voltage:2][current:2]
//PSU -> Computer: Confirm raw setpoints: [channel:1][voltage:2][current:2]
//This is a 'measurement' type message
#define MESSAGE_SET_SETPOINT_RAW			8

//Computer -> PSU: Request calibration for given channel / target / index: [channel:1][target:1][index:1]
//PSU -> Computer: Send raw setpoints: [channel:1][target:1][index:1][dac:2][adc:2][measured:2]
...
//This is a 'calibration' type message
#define MESSAGE_GET_CALIBRATION				9

//Computer -> PSU: Change calibration for given channel / target / index: [channel:1][target:1][index:1][dac:2][adc:2][measured:2]
...
//Computer -> PSU: Request startup value for given channel / target: [channel:1][target:1]
//PSU -> Computer: Send startup value for given channel / target: [channel:1][target:1][value:2]
//Target is one of the calibration targets below (voltage or current)
#define MESSAGE_GET_STARTUP_VALUE			11

//Computer -> PSU: Set startup value for given channel / target: [channel:1][target:1][value:2]
//PSU -> Computer: Confirm startup value for given channel / target: [channel:1][target:1][value:2]
//Target is one of the calibration targets below (voltage or current)
#define MESSAGE_SET_STARTUP_VALUE			12
...
#define MESSAGE_SET_DAC_ADDRESS				13
...
#define MESSAGE_SET_AREF					14

//Computer -> PSU: Jump to bootloader in preparation for uploading new firmware: []
// PSU -> Computer: N/A
// Once this is completed, psdfu command line tool can be used to flash new program.
// After programming, reset is done via a hard power cycle.
#define MESSAGE_BOOTLOADER_JUMP				15
