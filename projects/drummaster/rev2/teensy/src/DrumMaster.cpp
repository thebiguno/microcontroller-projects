...
AudioConnection          patchCord20(masterMixer, 0, i2s1, 0);
AudioConnection          patchCord21(masterMixer, 0, i2s1, 1);
...
int main(){
	...
	while (1){
		...
		if (button0.fallingEdge()) {
			...
			samples[sampleCounter].play("SDTEST1.WAV");
			sampleCounter = (sampleCounter + 1) & 0x0F;
		}
