...
static volatile uint8_t lamp_encoder_state = 0x00;		//Lamp encoder reads pins 4 and 5
static volatile int8_t music_encoder_movement = 0;
static volatile uint8_t music_encoder_state = 0x00;		//Music encoder reads pins 6 and 7
