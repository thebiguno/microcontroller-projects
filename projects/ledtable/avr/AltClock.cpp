	...
	while (running > 0) {
		...
		*/
		...
		if (running == 1) {
			...
			if (a & 0x01) matrix.rectangle(9,0,11,2,DRAW_FILLED);
			if (a & 0x02) matrix.rectangle(6,0,8,2,DRAW_FILLED);
			if (a & 0x04) matrix.rectangle(3,0,5,2,DRAW_FILLED);
			if (a & 0x08) matrix.rectangle(0,0,2,2,DRAW_FILLED);

			h.addHue(90);
			matrix.setColor(Rgb(h));
			if (b & 0x01) matrix.rectangle(9,3,11,5,DRAW_FILLED);
			if (b & 0x02) matrix.rectangle(6,3,8,5,DRAW_FILLED);
			if (b & 0x04) matrix.rectangle(3,3,5,5,DRAW_FILLED);
			if (b & 0x08) matrix.rectangle(0,3,2,5,DRAW_FILLED);
			
			h.addHue(90);
			matrix.setColor(Rgb(h));
			if (c & 0x01) matrix.rectangle(9,6,11,8,DRAW_FILLED);
			if (c & 0x02) matrix.rectangle(6,6,8,8,DRAW_FILLED);
			if (c & 0x04) matrix.rectangle(3,6,5,8,DRAW_FILLED);
			if (c & 0x08) matrix.rectangle(0,6,2,8,DRAW_FILLED);
			
			h.addHue(90);
			matrix.setColor(Rgb(h));
			if (d & 0x01) matrix.rectangle(9,9,11,11,DRAW_FILLED);
			if (d & 0x02) matrix.rectangle(6,9,8,11,DRAW_FILLED);
			if (d & 0x04) matrix.rectangle(3,9,5,11,DRAW_FILLED);
			if (d & 0x08) matrix.rectangle(0,9,2,11,DRAW_FILLED);
		}
			...
			matrix.setColor(Rgb(h));
			if (a & 0x01) matrix.rectangle(8,0,11,1,DRAW_FILLED);
			if (a & 0x02) matrix.rectangle(4,0,7,1,DRAW_FILLED);
			if (a & 0x04) matrix.rectangle(0,0,3,1,DRAW_FILLED);
			
			h.addHue(60);
			matrix.setColor(Rgb(h));
			if (b & 0x01) matrix.rectangle(8,2,11,3,DRAW_FILLED);
			if (b & 0x02) matrix.rectangle(4,2,7,3,DRAW_FILLED);
			if (b & 0x04) matrix.rectangle(0,2,3,3,DRAW_FILLED);
			
			h.addHue(60);
			matrix.setColor(Rgb(h));
			if (c & 0x01) matrix.rectangle(8,4,11,5,DRAW_FILLED);
			if (c & 0x02) matrix.rectangle(4,4,7,5,DRAW_FILLED);
			if (c & 0x04) matrix.rectangle(0,4,3,5,DRAW_FILLED);
			
			h.addHue(60);
			matrix.setColor(Rgb(h));
			if (d & 0x01) matrix.rectangle(8,6,11,7,DRAW_FILLED);
			if (d & 0x02) matrix.rectangle(4,6,7,7,DRAW_FILLED);
			if (d & 0x04) matrix.rectangle(0,6,3,7,DRAW_FILLED);

			h.addHue(60);
			matrix.setColor(Rgb(h));
			if (e & 0x01) matrix.rectangle(8,8,11,9,DRAW_FILLED);
			if (e & 0x02) matrix.rectangle(4,8,7,9,DRAW_FILLED);
			if (e & 0x04) matrix.rectangle(0,8,3,9,DRAW_FILLED);

			h.addHue(60);
			matrix.setColor(Rgb(h));
			if (f & 0x01) matrix.rectangle(8,10,11,11,DRAW_FILLED);
			if (f & 0x02) matrix.rectangle(4,10,7,11,DRAW_FILLED);
			if (f & 0x04) matrix.rectangle(0,10,3,11,DRAW_FILLED);
		}
			...
			else if (c == 10) matrix.line(2,3,2,4);
			...
			else if (d == 10) matrix.line(3,3,3,4);
		...
		if (running == 4) {
			...
			b = floor(ms / 2400000);		// 1/36 day = 40 m
			ms -= 2400000 * (uint32_t) b;
			ms *= 100;
			c = floor(ms / 40000000);		// 1/216 day = 6 m 40 s
			ms -= 40000000 * (uint32_t) c;
			ms *= 100;
			d = floor(ms / 666666666);		// 1/1296 day = 66.6 s
			ms -= 666666666 * (uint32_t) d;
			e = floor(ms / 111111111);		// 1/7776 day = 11.1 s
